      ...
      >
        ...
        >
          ...
          <WordButton
            ...
            func={(e)=>{
                window.open("https://firebasestorage.googleapis.com/v0/b/ansel-portofolio.appspot.com/o/CV%20ATS.pdf?alt=media&token=d7d269ae-58be-4d41-8ccf-4969b2946629")
            }}
          />
        </div>
        <div
        ...
        >
          ...
          >
            {aboutContent.find((x) => x.title === active)?.content}
          </Typography>
        </div>
      </div>
    </div>
